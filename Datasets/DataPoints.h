...
public:
	...
	bool __fastcall SetPointGeoTime (const String &strDate, const String &strTime, TStringList *lstrTokens);
	String __fastcall GetSqlInsertString () const;
	String __fastcall GetDateTimeString () const;
// ---------- Database Support ----------
...
// Vector Database Support
	bool __fastcall LoadFromDB (TADOQuery *query, String &strErr, int idRoute=-1);
	bool __fastcall LoadFromDB (TADOConnection *db, String &strErr, int idRoute=-1);
	bool __fastcall InsertAll (TADOQuery *query, String &strErr);
	bool __fastcall LoadRoutePoints (int idRoute, TADOQuery *query, String &strErr);
};
//------------------------------------------------------------------------------
#endif
